...
// ------------------------------------------------------------------
//  🎵 TikTok Webhook Handler (Integrated)
// ------------------------------------------------------------------
async function handleTikTokWebhook(req, res) {
  ...
  try {
    ...
    switch (event) {
      case 'video.upload':
        await handleTikTokVideoUpload(data, workspaceId);
        break;
        
      case 'video.status':
        await handleTikTokVideoStatusUpdate(data, workspaceId);
        break;
        
      case 'comment.create':
        await handleTikTokCommentCreate(data, workspaceId);
        break;
        
      case 'follower.update':
        await handleTikTokFollowerUpdate(data, workspaceId);
        break;
...
// ------------------------------------------------------------------
async function handleTikTokVideoUpload(data, workspaceId) {
...
async function handleTikTokVideoStatusUpdate(data, workspaceId) {
...
async function handleTikTokCommentCreate(data, workspaceId) {
...
async function handleTikTokFollowerUpdate(data, workspaceId) {
